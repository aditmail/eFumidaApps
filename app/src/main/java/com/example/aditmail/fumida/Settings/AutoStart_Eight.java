...
public class AutoStart_Eight extends BroadcastReceiver {
        ...
        if (intent != null) {
            ...
            if (intent.getAction() != null) {
                ...
                if (intent.getAction().equalsIgnoreCase(Intent.ACTION_BOOT_COMPLETED)) {
                    ...
                    autoStart.serviceAtEight();
                    Log.e("tag", "Service at Eight After Boot");
                }
            } else {
                ...
                Data data = new Data.Builder()
                        ...
                        .putString(MyWorker.CHECK_WHICH_SERVICES_TO_RUN, "Services_at_eight")
                        .build();
