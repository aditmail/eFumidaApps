...
public class MyServices_Eight extends Service {
...
//        alarmAtEight();
    ...
    private void getCurrentLocationRoute(){
        ...
        if(gps.canGetLocation()){
            ...
            alamat_eight = convertLocation(latitude, longitude);
    ...
    private void sendLocation_Eight(){
        ...
        class simpan extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... v) {
                ...
                res = rh.sendPostRequest(Konfigurasi.URL_SEND_LOCATION, params);
    ...
    private void saveLocToDB(){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Konfigurasi.URL_CEK_ABSENSI_AT_EIGHT, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(Konfigurasi.KEY_GET_ALAMAT, alamat_eight);
