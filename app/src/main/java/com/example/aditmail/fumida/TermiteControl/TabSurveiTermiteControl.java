...
public class TabSurveiTermiteControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_survei_termite_control);
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new FragmentFormTermite(), "Form Survei");
        adapter.addFragment(new FragmentDataTermite(), "Data Survei");
